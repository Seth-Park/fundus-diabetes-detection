...
def build_model(input_var):
    ...
    drop_1 = nn.layers.DropoutLayer(layers[-1], p=0.3)
    ...
    drop_2 = nn.layers.DropoutLayer(layers[-1], p=0.3)
    ...
    drop_3 = nn.layers.DropoutLayer(layers[-1], p=0.3)
    layers.append(drop_3)

    softmax_layer = DenseLayer(layers[-1],
